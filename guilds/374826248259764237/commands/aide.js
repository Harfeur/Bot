exports.run = (client, message, args) => {
    let help = ['```xl',
        ...
        process.env.prefix + 'radio : "Affiche la liste des radios disponibles"',
        ...
        '',
        'Commandes pour la musique YouTube:'.toUpperCase(),
        ...
        '',
        'Ces commandes fonctionnent uniquement en lecture de musique YouTube:'.toUpperCase(),
